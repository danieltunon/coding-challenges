...
assert.deepEqual([...sumListsForward(N617, N295).values()], [...N912.values()], 'should return the correct sum');
...
assert.deepEqual([...sumListsForward(N1417, N95).values()], [...N1512.values()], 'should return the correct sum');
...
assert.deepEqual([...sumListsForward(N6439, N7825).values()], [...N14264.values()], 'should return the correct sum');
